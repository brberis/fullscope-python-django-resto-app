    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('backorder_level', models.IntegerField(default=1, help_text='The number of items that may be backordered.', verbose_name='Backorder Level')),
                ('preorder_level', models.IntegerField(default=1, help_text='The number of items that may be preorderable.', verbose_name='Preorder Level')),
