...
class Inventory(models.Model):
    ...
    backorder_level = models.IntegerField(verbose_name=('Stock Level'), default = 1, help_text=('The number of items that may be backordered.')) 
    preorder_level = models.IntegerField(verbose_name=('Stock Level'), default = 1, help_text=('The number of items that may be preorderable.')) 
